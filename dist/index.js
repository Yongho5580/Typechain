...
var Block = /** @class */ (function () {
    ...
    Block.validateStructure = function (aBlock) { return typeof aBlock.index === "number" && typeof aBlock.hash === "string" && typeof aBlock.previousHash === "string" && typeof aBlock.timestamp === "number" && typeof aBlock.data === "string"; };
    return Block;
}());
var genesislock = new Block(0, "65465406804", "", "Hello", 123456);
var blockchain = [genesislock];
